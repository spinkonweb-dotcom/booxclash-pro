...
const ALL_GAME_ITEMS: GameItem[] = [
  // Day Items
  { id: "sunglasses", name: "Sunglasses", emoji: "🕶️", category: "day" },
  { id: "rooster", name: "Rooster", emoji: "🐓", category: "day" },
  { id: "schoolbus", name: "School Bus", emoji: "🚌", category: "day" },
  { id: "butterfly", name: "Butterfly", emoji: "🦋", category: "day" },
  { id: "sun", name: "Sun", emoji: "☀️", category: "day" },
  { id: "icecream", name: "Ice Cream", emoji: "🍦", category: "day" },

  // Night Items
  { id: "pajamas", name: "Pajamas", emoji: " pajamas", category: "night" }, // Using emoji directly
  { id: "owl", name: "Owl", emoji: "🦉", category: "night" },
  { id: "stars", name: "Stars", emoji: "✨", category: "night" },
  { id: "bed", name: "Bed", emoji: "🛏️", category: "night" },
  { id: "moon", name: "Moon", emoji: "🌙", category: "night" },
  { id: "bat", name: "Bat", emoji: "🦇", category: "night" },
];

const BINS: { category: ItemCategory; emoji: string; label: string; color: string; highlight: string; }[] = [
  { category: "day", emoji: "☀️", label: "Day", color: "bg-blue-500", highlight: "border-blue-300" },
  { category: "night", emoji: "🌙", label: "Night", color: "bg-indigo-700", highlight: "border-indigo-400" },
];
...
const DayOrNightSortGame: React.FC<LessonProps> = ({ onComplete }) => {
  // --- STATE ---
  const [unsortedItems, setUnsortedItems] = useState<GameItem[]>([]);
  const [sortedItems, setSortedItems] = useState<{ [key in ItemCategory]: GameItem[] }>({ day: [], night: [] });
  ...
  if (isGameComplete) {
    return (
      <div className="p-6 text-center flex flex-col items-center justify-center h-full text-white">
        ...
        <p className="text-lg mb-6">You know all about Day and Night!</p>
        <button
          onClick={onComplete}
  ...
  return (
    <div className="p-4 flex flex-col h-full text-white overflow-hidden">
      <h3 className="text-2xl font-bold text-center mb-4">Day or Night?</h3>
...
export default DayOrNightSortGame;